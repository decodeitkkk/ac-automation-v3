                ...
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center justify-between flex-grow">
                        <div class="flex-shrink-0">
                            <h1
                                class="text-lg font-semibold tracking-widest text-white uppercase"
                            >
                        ...
                        <div class="hidden lg:block">
                            <div class="flex items-center">
                                ...
                                <div class="relative" x-data="{ open: false}">
                                    ...
                                    >
                                        <div
                                            class="py-1 bg-white rounded-md shadow-sm border z-50 "
                                        >
                                        ${productsData
                                            .map(
                                                (item) => `
            ...
            >
                <div class="container px-6 mx-auto">
                    <div class="pt-2 pb-3">
                        ...
                        >
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-building-2"><path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z"/><path d="M6 12H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2"/><path d="M18 9h2a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-2"/><path d="M10 6h4"/><path d="M10 10h4"/><path d="M10 14h4"/><path d="M10 18h4"/></svg>
                            <span class="ml-2">About Us</span>
                        </a>
                        <div class="relative" x-data="{ open: false }">
                            <button
                            ...
                            <div
                                x-show="open"
                                @click.away="open = false"
                                class="px-2 py-2 mt-2 bg-white rounded-md shadow-xs"
                                role="menu"
                            ...
                            ${productsData
                                .map(
                                    (item) => `
                                <a
                                    href="/src/products/allProducts.html"
                                    class="flex flex-row items-center px-4 py-2 text-sm text-gray-700 focus:text-gray-900 hover:text-gray-900 focus:outline-none hover:bg-gray-100 focus:bg-gray-100"
                                >
                                    ${item.brand}
                                </a>
