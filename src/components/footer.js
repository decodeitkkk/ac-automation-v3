        ...
        <div class="text-center sm:text-left">
          ...
          <nav class="mt-8">
            <ul class="space-y-4 text-sm">
              ...
              <li>
                <a class="text-white transition hover:text-white/75" href="/about/about.html">
                  About Us
                </a>
              </li>

              <li>
                <a class="text-white transition hover:text-white/75" href="/brands/brands.html">
                  Brands
                </a>
              </li>

              <li>
                <a class="text-white transition hover:text-white/75" href="/products/allProducts.html">
                  Products
                </a>
              </li>
            </ul>
