    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        <p class="max-w-md mx-auto mt-6 leading-relaxed text-center text-gray-400 sm:max-w-xs sm:mx-0 sm:text-left">
          Your partner in industrial automation, delivering excellence with competitive prices and timely support.
        </p>
        ...
        <div class="text-center sm:text-left">
          ...
          <nav class="mt-8">
            <ul class="space-y-4 text-sm">
              <li>
                <a class="text-white transition hover:text-white/75" href="/src/index.html">
                  Home
                </a>
              </li>

              <li>
                <a class="text-white transition hover:text-white/75" href="/src/pages/about.html">
                  About Us
                </a>
              </li>

              <li>
                <a class="text-white transition hover:text-white/75" href="/src/pages/brands.html">
                  Brands
                </a>
              </li>
