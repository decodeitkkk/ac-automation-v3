...
<footer class="bg-gray-900">
            ...
            >
                <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <div
                            class="flex justify-center text-3xl font-medium text-teal-300 sm:justify-start"
                        >
                            A. C. Automation
                        </div>
                        ...
                        <ul
                            class="flex justify-center gap-6 mt-8 md:gap-8 sm:justify-start"
                        >
                            <li>
                                <a
                                    href="/"
                    ...
                    <div
                        class="grid grid-cols-1 gap-8 lg:col-span-2 md:grid-cols-2"
                    >
                            ...
                            <nav class="mt-8">
                                <ul class="space-y-4 text-sm">
                                    ...
                                    <li>
                                        <a
                                            class="text-white transition hover:text-white/75"
                                            href="/products/allProducts.html"
                                        >
                                            Products
                                        </a>
                                    </li>
                        ...
                        <div class="text-center sm:text-left">
                            ...
                            <ul class="mt-8 space-y-4 text-sm">
                                ...
                                >
                                    ...
                                    <address
                                        class="-mt-0.5 not-italic text-white"
                                    >
                ...
                <div class="pt-6 mt-12 border-t border-gray-800">
                    ...
                    >
                        ...
                        <p
                            class="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0"
                        >
